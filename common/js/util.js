...
util.jwxModule = function(options,title,desc,link,imgUrl){
	...
	var unionid="18340070905";
	var nowExhId=122;
	var exType=4;
	
	if(exType==1){
		title="第9届绿色低碳环保产业国际博览会参观登记";
		desc="时间：2023.5.25-27地点：山东国际会展中心(济南)";  
		...
		title="第四届山东体育用品博览会";
		desc="时间：2023.7.28-7.30地点：临沂国际博览中心（临西十路）";
		...
		desc="时间：2023年6.29-7.01  地址：西安国际会展中心";
		...
		desc="时间：2023年9.19-21日  地址：菏泽国际会展中心";
		imgUrl="https://shandongtibohui.zsyflive.com/profile/upload/2022/08/03/04f7e815a9eb25409e8a24090a436cf.jpg";
	}else if(exType==10){
		var title="南宁全屋定制供应链展"
		// var title="广西定制家居供应链展"
		desc="时间：2024年3.21-23日  地址：南宁国际会展中心";
		imgUrl="https://shandongtibohui.zsyflive.com/profile/upload/2022/08/03/e9099b2b1b1d5c31a932af696294735.jpg";
	}
	  
	  console.log("--配置----","https://gtyq.imjiayi.com/",
		  {
			 appId: options.appId, // 必填，公众号的唯一标识
			 timestamp: options.timestamp, // 必填，生成签名的时间戳
			 nonceStr: options.noncestr, // 必填，生成签名的随机串
	...
	var title="上海市级医疗机构护工护理员职业技能竞赛"  
		...
		var desc="在线学习";
		 // var  link = "https://gtyq.imjiayi.com";
	jweixin.hideMenuItems({
		...
		jweixin.updateAppMessageShareData({ 
			title: title, // 分享标题
			desc: desc, // 分享描述
			link: "https://gtyq.imjiayi.com/", // 分享链接，该链接域名或路径必须与当前页面对应的公众号JS安全域名一致
			imgUrl: imgUrl, // 分享图标
			success: function (res) {
